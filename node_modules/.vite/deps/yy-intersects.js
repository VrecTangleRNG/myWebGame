...
//#region node_modules/yy-intersects/src/shape.js
	...
	module.exports = class Shape {
		...
		*/
		collidesPoint(point) {
			...
			for (let i = 0, j = length - 2; i < length; i += 2) {
				if (vertices[i + 1] > point.y !== vertices[j + 1] > point.y && point.x < (vertices[j] - vertices[i]) * (point.y - vertices[i + 1]) / (vertices[j + 1] - vertices[i + 1]) + vertices[i]) c = !c;
				j = i;
			}
			return c;
		}
		...
		*/
		collidesLine(p1, p2) {
			const vertices = this.vertices;
			const length = vertices.length;
			if (this.collidesPoint(p1)) return true;
			for (let i = 0; i < length; i += 2) {
				const j = (i + 2) % length;
				if (Shape.lineLine(p1, p2, {
					x: vertices[i],
					y: vertices[i + 1]
				}, {
					x: vertices[j],
...
//#endregion
//#region node_modules/yy-intersects/src/rectangle.js
var require_rectangle = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	...
	module.exports = class Rectangle extends Shape {
		...
		*/
		set(options) {
			...
			if (typeof options.square !== "undefined") this._width = this._height = options.square;
			else {
		...
		*/
		...
		get vertices() {
			if (this.verticesDirty) this.updateVertices();
		...
		*/
		collidesRectangle(rectangle) {
			if (this.noRotate && rectangle.noRotate) return this.AABBs(rectangle.AABB);
			else return this.collidesPolygon(rectangle);
		}
		/**
...
//#endregion
//#region node_modules/yy-intersects/src/polygon.js
var require_polygon = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* @file src/polygon.js
	* @author David Figatner
	* @license MIT
	...
	*/
	...
	var Polygon = class extends Shape {
		...
		*/
		set(options) {
			if (options.point) this.points = options.points;
			this.center = options.center || this.article;
			this.rotation = options.rotation ? options.rotation : options.center ? options.center : this.article;
			this.update();
		}
...
//#endregion
//#region node_modules/yy-intersects/src/circle.js
var require_circle = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	* @file src/circle.js
	* @author David Figatner
	* @license MIT
	...
	var Circle = class extends Shape {
		...
		*/
		collidesLine(p1, p2) {
			...
			return dot(h, h) <= this.radiusSquared;
		}
		/**
		...
		*/
		collidesRectangle(rectangle) {
			if (rectangle.noRotate) {
				...
				if (distX > hw + radius || distY > hh + radius) return false;
				...
				const center = this.center;
				if (rectangle.collidesPoint(center)) return true;
		...
		collidesPolygon(polygon) {
			const center = this.center;
			if (polygon.collidesPoint(center)) return true;
			const vertices = polygon.vertices;
			const count = vertices.length;
			for (let i = 0; i < count - 2; i += 2) if (this.collidesLine({
				x: vertices[i],
				y: vertices[i + 1]
			}, {
				x: vertices[i + 2],
...
//#endregion
//#region node_modules/yy-intersects/intersects.js
