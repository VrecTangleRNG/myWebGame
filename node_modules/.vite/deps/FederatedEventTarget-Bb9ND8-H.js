import { H as warn, ht as ExtensionType, mt as eventemitter3_default, ut as Point } from "./CanvasPool-DOie_UcP.js";
import { B as removeItems, i as Ticker, o as UPDATE_PRIORITY } from "./Filter-oI80x9ov.js";
	...
	setCursor(mode) {
		...
		if (style) switch (typeof style) {
			...
			case "function":
				style(mode);
				break;
			case "object": if (applyStyles) Object.assign(this.domElement.style, style);
		}
