import { G as Texture, H as warn, I as InstructionSet, L as multiplyHexColors, N as DOMAdapter, R as BigPool, U as Color, W as Bounds, X as definedProps, gt as extensions, ht as ExtensionType, it as v8_3_4, lt as Matrix, mt as eventemitter3_default, nt as v8_0_0, ot as uid, st as Rectangle, tt as deprecation, ut as Point } from "./CanvasPool-DOie_UcP.js";
import { r as ImageSource } from "./canvasUtils-f7vuOx6C.js";
import { t as getTextureBatchBindGroup } from "./getTextureBatchBindGroup-Dky_qHs4.js";
import { n as DefaultBatcher, t as GCManagedHash } from "./GCManagedHash-Ct0R8-Q-.js";
...
var Ellipse = class Ellipse {
	...
	*/
	strokeContains(x, y, strokeWidth, alignment = .5) {
		...
		if (normalizedX * normalizedX / (outerHorizontal * outerHorizontal) + normalizedY * normalizedY / (outerVertical * outerVertical) > 1) return false;
		if (innerHorizontal <= 0 || innerVertical <= 0) return true;
		return normalizedX * normalizedX / (innerHorizontal * innerHorizontal) + normalizedY * normalizedY / (innerVertical * innerVertical) > 1;
	}
	/**
...
function parseRadialGradient(child) {
	const cx = parseGradientCoordinate(child, "cx", .5);
	const cy = parseGradientCoordinate(child, "cy", .5);
	const r = parseGradientCoordinate(child, "r", .5);
